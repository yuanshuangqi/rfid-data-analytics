...
<div>
        ...
        <div class="page-header-search">
            <el-form :inline="true" :model="search" ref="searchForm" @submit.native.prevent>
                <el-form-item prop="menuName">
                    ...
                    <span class="condition">检针时间</span>
                    <div class="el-input">
                    <el-date-picker
    ...
    <div class="page-main">
        <el-table :data="metalCheckData" size="small">
...
<script>
    import {getData,getDictionaryInfo,downloadData} from 'api/metalcheck'
        ...
        methods:{
            ...
            download(){
                downloadData(this.search).then(res => {
                    ...
                    link.setAttribute('download', '检针信息表' + num + '.xls');
            ...
            loadTableData(){
                getData(this.search).then(res => {
                        this.metalCheckData = res.data.metalCheckData
            ...
            loadDictionary(){
                getDictionaryInfo('MetalCheck').then(res => {

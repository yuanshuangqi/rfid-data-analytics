...
<div>
        ...
        <div class="page-header-search">
            <el-form :inline="true" :model="search" ref="searchForm" @submit.native.prevent>
                <el-form-item prop="menuName">
                    ...
                    <span class="condition">颜色</span><el-input v-model="search.colorCode" placeholder="颜色" size="small" @keydown.enter.native="query"/><br>
    ...
    <div class="page-main">
        <el-table :data="orderData" size="small">
            ...
            <el-table-column prop="buCode" label="国家" width = "100"/>
            <el-table-column prop="skuCode" label="SKU"/>
            <el-table-column prop="sampleCode" label="款号"/>
            <el-table-column prop="color" label="颜色"/>
            <el-table-column prop="size" label="尺寸"/>
            <el-table-column prop="patternDimensionCode" label="花型" width = "100"/>
            <el-table-column prop="orderQty" label="计划数" width = "60"/>
            <el-table-column prop="baggingQty" label="包装数" width = "60"/>
            <el-table-column prop="metalCheckQty" label="检针数" width = "60"/>
        </el-table>
    </div>
...
<script>
    import {getData,downloadData} from 'api/order'
        ...
        methods:{
            ...
            download(){
                downloadData(this.search).then(res => {
                    ...
                    link.setAttribute('download', '订单信息表' + num + '.xls');
